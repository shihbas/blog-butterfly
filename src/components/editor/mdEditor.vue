...
export default {
  ...
  data() {
    return {
      simplemde: null,
      hasChange: false,
      defaultToolBar: ['bold', 'italic', 'strikethrough', '|', 'heading', 'heading-1', 'heading-2', 'heading-3', 'heading-smaller', 'heading-bigger', '|', 'code', 'quote', '|', 'unordered-list', 'ordered-list', 'clean-block', '|', 'horizontal-rule', 'link', 'image', 'table', '|', 'preview', 'side-by-side', 'fullscreen', '|', 'guide']
    }
  },
  watch: {
    value(val) {
